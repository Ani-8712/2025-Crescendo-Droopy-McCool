...
public class AutoCommands implements AllianceObserver {
    ...
    private final String s2_to_n1 = "s2 to n1";
    ...
    public final AutonomousMode redFour_S2N1N2N3;
    ...
    public Command getScoringSequenceF2F3(Alliance color) {
        return Commands.sequence(
                ...
                followChoreoPathWithOverrideNoverrideFast(shoot1_to_f3, color));
    }

    public Command getScoringSequenceF3F4(Alliance color) {
        return Commands.sequence(
                followChoreoPathWithOverride(f3_to_shoot1, color),
                target().withTimeout(0.8),
    ...
    public Command testForward() {
        return followChoreoPathWithOverride("test Forward", Alliance.Blue);
    }

    public Command testRight() {
        return followChoreoPathWithOverride("test right", Alliance.Blue);
    }
    ...
    public Command preloadMove() {
        return Commands.sequence(
                scorePreload(), Commands.waitSeconds(2), followChoreoPathWithOverride(s3_preload_move, color));
    }
    ...
    public Command four_S2N1N2N3(Alliance color) {
        return Commands.parallel(
                close4SuperstructureSequence(color),
                Commands.sequence(
                        target().withTimeout(0.5),
        ...
        return new FunctionalCommand(
                ...
                () -> {
                    ...
                    PathPlannerLogging.logTargetPose(
                            trajectory
                                    .sampleAt(timer.get(), mirrorTrajectory.getAsBoolean())
                                    .getPose());
                    ;
        ...
        return (pose, referenceState) -> {
            ...
            double rotationFeedback =
                    rotationController.calculate(
                            pose.getRotation().getRadians(), referenceState.getPose().getRotation().getRadians());
    ...
    public interface ChoreoControlFunction extends BiFunction<Pose2d, TrajectorySample, ChassisSpeeds>  {
