...
public class SwerveDriveConstants {
    ...
    public static final RobotConfig ppRobotConfig = new RobotConfig(defaultAccel, kDriveMotorGearRatio, 
    new ModuleConfig(kWheelRadiusInches, kDriveD, kWheelBase, new DCMotor(kNominalVoltage, defaultAccel, kStallCurrent, kMaxCurrent, kRotPossibleMaxSpeedRadPerSec, 0), kMaxCurrent, 0)
    , kTrackWidth);
